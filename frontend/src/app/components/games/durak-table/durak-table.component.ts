...
import {CardDTO, DurakMetaDTO, GameDTO, HandDTO, ObligationDTO, TransferDTO} from "../../utils/dto";
...
import {UnoService} from "../uno-table/uno-service";
...
export class DurakTableComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (this.game?.meta) {
            this.determineIfItsYourTurn(<DurakMetaDTO>this.game.meta)
        }
    ...
    private determineIfItsYourTurn(meta: DurakMetaDTO) {
        this.yourTurn = meta.attacker.username === this.username;
    }
